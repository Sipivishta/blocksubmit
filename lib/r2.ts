 ...
 *
 * `disposition` controls whether the browser downloads the file or
 * renders it inline — never trusted from the client; callers must pass
 * a value derived from the submission's server-detected mime_type (see
 * the download route), not anything supplied in the request.
 */
